# -*- coding: utf-8 -*-
"""
Created on Wed Jan 11 19:41:39 2023
...
thislist = ["apple", "banana", "cherry"]
if "appl" in thislist:
  print("Yes, 'appl' is in the fruits list")
else:
    print("no 'appl' is not in list")
...
#outcome, which you can manipulate before it ends up like a list item in the new list:
